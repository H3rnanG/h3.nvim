...
km.set('n', 'y', '"+y', { noremap = true })
km.set('v', 'y', '"+y', { noremap = true })
km.set('n', 'd', '"+d', { noremap = true })
km.set('v', 'd', '"+d', { noremap = true })
km.set('n', 'p', '"+p', { noremap = true })
km.set('v', 'p', '"+p', { noremap = true })
